...
# saveRDS(pred_tst, file = "pred_tst_ames.RDS")
# pred_tst <- readRDS(file = "pred_tst_ames.RDS")
...
print(Sys.time() - begin) # ~ 10.5 minutes

# saveRDS(pred, file = "pred_ames.RDS")
# pred <- readRDS(file = "pred_ames.RDS")
...
# saveRDS(cp_interval, file = "cp_interval_ames.RDS")
# cp_interval <- readRDS(file = "cp_interval_ames.RDS")
