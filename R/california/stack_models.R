# Model stacking (California Housing)
...
saveRDS(stack_tst, file = "stack_tst_california.RDS")
...
print(Sys.time() - begin) # ~ 11 minutes

saveRDS(stack_trn, file = "stack_trn_california.RDS")
